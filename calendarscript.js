...
function qTipText(start, end, description, place_name, room_name_th) {
    var text;

    if (end !== null)
        text = "<strong>Start:</strong> " + start.format("DD/MM/YYYY h:mm a") + "<br/><strong>End:</strong> " + end.format("DD/MM/YYYY h:mm a") + "<br/><strong>Detail:</strong>" + description + "<br/><strong>สถานที่:</strong>" + place_name + "<br/><strong>ชื่อห้อง:</strong>" + room_name_th;
    else
        text = "<strong>Start:</strong> " + start.format("DD/MM/YYYY h:mm a") + "<br/><strong>End:</strong><br/><br/>" + description + place_name + room_name_th;
